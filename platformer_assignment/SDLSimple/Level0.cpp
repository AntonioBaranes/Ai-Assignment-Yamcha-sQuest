...
void Level0::initialise()
{
    ...
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVEL0_DATA, map_texture_id,
        1.0f, 8, 3);
    ...
    m_game_state.enemies->set_position(glm::vec3(0.0f, 0.0f, 0.0f));
...
void Level0::update(float delta_time)
{
    ...
    if (m_game_state.enemies->check_collision(m_game_state.attack)) {
...
void Level0::render(ShaderProgram* program)
{
    ...
    //program->set_light_position_matrix();
